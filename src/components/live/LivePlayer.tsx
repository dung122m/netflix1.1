    ...
    <div className="space-y-4">
      ...
      >
        ...
        {matchOptions.length > 0 && (
          <>
            {/* NÚT MỞ DANH SÁCH KÊNH Ở CẠNH PHẢI CỦA PLAYER (GIỐNG BÊN TRUYỀN HÌNH) */}
            <div
            ...
            {/* DRAWER DANH SÁCH KÊNH & TRẬN ĐẤU */}
            <aside
              className={`absolute inset-y-0 right-0 z-40 w-[min(88vw,350px)] border-l border-white/15 bg-zinc-950/95 p-3 sm:p-3.5 shadow-2xl backdrop-blur-2xl transition-transform duration-300 flex flex-col ${
                isRailVisible
            ...
            >
              <div className="mb-2.5 flex items-center justify-between border-b border-white/10 pb-2 flex-shrink-0">
                ...
                <button
                  type="button"
                  onClick={closeRail}
                  className="rounded-lg p-1.5 text-gray-400 hover:bg-white/10 hover:text-white transition flex-shrink-0 cursor-pointer"
                  title="Đóng danh sách (Esc hoặc Phím L)"
                >
                  <X className="h-4 w-4" />
                </button>
              </div>
              ...
              <div className="relative mb-2 flex-shrink-0">
                ...
                <input
                  ...
                  className="w-full pl-8 pr-7 py-1.5 rounded-xl bg-white/5 border border-white/10 text-xs text-white placeholder-gray-500 focus:outline-none focus:border-netflix-red transition"
                />
                {railSearch && (
                  <button
                    type="button"
              ...
              <div className="flex items-center gap-1 mb-2.5 overflow-x-auto scrollbar-none flex-shrink-0 pb-0.5">
                <button
                  type="button"
                ...
                <button
                  ...
                  className={`flex items-center gap-1 px-2.5 py-1 rounded-lg text-[10px] font-bold whitespace-nowrap transition cursor-pointer ${
                    railFilter === "live"
                      ? "bg-netflix-red text-white font-extrabold"
                ...
                <button
                  ...
                  className={`flex items-center gap-1 px-2.5 py-1 rounded-lg text-[10px] font-bold whitespace-nowrap transition cursor-pointer ${
                    railFilter === "fpt"
                      ...
                      : "bg-white/5 text-orange-300 hover:bg-white/10"
                  }`}
                >
                  <span>⚡ FPT Play</span>
                </button>
                  ...
                  filteredRailOptions.map((option) => {
                    ...
                    return (
                      <button
                        ...
                        className={`w-full rounded-xl border p-2 text-left transition flex items-center gap-2.5 cursor-pointer ${
                          isCurrent
                            ? "border-netflix-red/70 bg-red-500/15 text-white shadow-md shadow-red-950/40"
                            : "border-white/10 bg-white/[0.03] text-gray-300 hover:border-white/25 hover:bg-white/[0.08]"
                        }`}
                      >
                        {/* Thumbnail / Logo */}
                        <div className="w-9 h-9 rounded-lg bg-zinc-900/90 border border-white/15 p-1 flex items-center justify-center flex-shrink-0 overflow-hidden">
