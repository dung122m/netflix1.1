...
export const Footer: React.FC = () => {
  return (
    <footer className="relative bg-gradient-to-b from-transparent via-zinc-950/90 to-black text-gray-400 pt-16 pb-12 px-4 sm:px-8 md:px-16 mt-20 border-t border-white/10 overflow-hidden">
