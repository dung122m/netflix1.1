  ...
  if (isMobileInline) {
    return (
      <div className="py-2.5 space-y-3">
        {/* CHẾ ĐỘ SÁNG / TỐI TRÊN MOBILE */}
        <div>
          <div className="flex items-center gap-1.5 text-xs text-gray-400 font-bold uppercase tracking-wider mb-2 px-1">
            {currentMode === "dark" ? (
          ...
          <div className="grid grid-cols-2 gap-2">
            <button
              ...
              className={`flex items-center justify-center gap-2 py-2 rounded-xl border text-xs font-bold transition cursor-pointer ${
                currentMode === "dark"
                  ? "bg-zinc-800 text-white border-white/30 shadow-sm"
                  : "bg-zinc-900/60 text-gray-400 border-white/10"
              }`}
            >
              <Moon className="w-3.5 h-3.5 text-amber-300" />
        ...
        {/* BẢNG MÀU CHỦ ĐỀ TRÊN MOBILE */}
        <div>
          <div className="flex items-center gap-1.5 text-xs text-gray-400 font-bold uppercase tracking-wider mb-2 px-1">
            <Palette className="w-3.5 h-3.5" style={{ color: currentTheme.color }} />
                ...
                <button
                  ...
                  className={`flex flex-col items-center gap-1 p-2 rounded-xl border transition-all cursor-pointer ${
                    isSelected
                      ...
                      : "bg-zinc-900/80 border-white/10 hover:border-white/20 text-gray-300"
                  }`}
                >
                  <div
                    className="w-5 h-5 rounded-full shadow-sm flex items-center justify-center text-[10px]"
                    style={{
