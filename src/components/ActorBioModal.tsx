  ...
  return (
    ...
    >
      <div
        ...
        className="relative w-full max-w-lg bg-zinc-950 rounded-3xl border border-white/20 shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200"
      >
        {/* HEADER BAR */}
