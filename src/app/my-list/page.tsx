                    ...
                    <Link href={href} className="block">
                      <div className="relative aspect-video w-full bg-zinc-800 overflow-hidden">
                        ...
                        <button
                          ...
                          className="absolute top-2 right-2 p-1.5 rounded-full bg-black/60 text-gray-300 hover:text-white hover:bg-black/90 backdrop-blur-sm transition z-10 opacity-0 group-hover:opacity-100"
                        >
                          <X className="w-4 h-4" />
                        </button>
                      </div>
